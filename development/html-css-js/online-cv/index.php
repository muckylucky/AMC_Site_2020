  ...
  <header class="tablet">
    ...
    <article class="clearfix" id="main">
        ...
        <article class="article-section" id="statement">
			...
			<p>At Selligent Marketing Cloud (<em>SMC</em>) I work in an awesome Design team for our Senior Product Designer and alongside one other Product Designer to test and improving existing features and design new ones for our Marketing Cloud software.</p>
            <p>A comprehensive list of clients using SMC can be <a href="https://www.selligent.com/industries">found here</a>.</p>

            <p>I also own my family name&rsquo;s dotcom address :)<br /><a href="http://mccluckie.com/" target="blank">McCluckie.com</a></p>
        </article>
        <!--END STATEMENT-->

...
<div class="wrapper">
    ...
    <div class="header-contact">
            <ul>
                ...
                <li style="padding-left:30px;background:url(img/social-linkedin.svg) 0 4px no-repeat;background-size:24px"><a href="https://www.linkedin.com/profile/view?id=AAMAAAE3JtcBUgFl9c9hQly5KK_tEDo6WYz0YME&trk=hp-identity-name">Linkedin</a></li>
            </ul>
    </div>
<!--
  <header class="tablet">
    ...
    <article class="clearfix" id="main">
        ...
        <article class="article-section-full-width clearfix" > 
            ...
            <section class="skillset-column">
                ...
                <ul class="adobe-icons">
                    <li><img src="img/axure_icon_125.svg" width="46" height="46" alt="Sketch"></li>
        ...
        <article class="article-section" id="work-history">
            ...
            <section class="job-entry">
                ...
                <section>
                    <h1>Campaign and web developer <small>&mdash;Selligent </small></h1>
                    <p>I build bomb-proof (well, Outlook proof anyway) responsive email templates. I then take briefs from marketers to set-up batch/transactional/repeat campaigns using client data to create highly segmented and personalised experiences.</p>
                </section>            
            </section>
            <section class="job-entry">
    ...
    solutions to marketing in a very fast-paced environment to tight deadlines whilst managing the expectations of internal stakeholders. Design and production of marketing emails and also Flash based banners.</p>
                    ...
                    <section class="job-project">
                        ...
                        <a href="projects/proj-vitality-quick-quote.php" class="primary-button">Read more</a>
                        ...
                        <div class="project-thumbnail">
                    		<a href="https://www.vitality.co.uk/health-insurance/quote">
                            	<img src="img/projects/cv-project-q-quote.gif" width="640" height="965" alt="Project preview">
                            </a>
                        </div>
                    </section>                
                                    
                    <section class="job-project">
    					<h3><a href="projects/proj-spending-calc.php">Spending calculator</a></h3>
                        <p>This is a personal project I started with the aim of tracking my monthly spending since the last pay day.</p>
                        <a href="projects/proj-spending-calc.php" class="primary-button">Read more</a>

                        <div class="project-thumbnail">
                    		<a href="projects/proj-spending-calc.php">
                            	<img src="img/projects/cv-project-spending-calc.gif" width="400" height="597" alt="Project preview">
                            </a>
                        </div>
                    </section>                
                    ...
                    <section class="job-project">
                        ...
                        <a href="projects/proj-vitality.php" class="primary-button">Read more</a>
                        <a href="http://vitality.co.uk/" class="secondary-button">Visit Vitality.co.uk</a> 
                        <div class="project-thumbnail">
                    		<a href="http://vitality.co.uk/">
                            	<img src="img/projects/cv-project-vitality.png" width="1219" height="1287" alt="Project preview">
                            </a>
                        </div>
    				</section>                
                    ...
                    <section class="job-project">
                        ...
                        <div class="project-thumbnail">
                    		<a href="https://www.pruprotect.co.uk/PruProtectOnline/quote/">
                            	<img src="img/projects/cv-project-D2C-quote.png" width="1223" height="1277" alt="Project preview">
                            </a>
                        </div>
    				</section>
        ...
        Designed and built entire PruProtect website. Constant evolution of look and feel. Monitoring of analytics in order to make informed evolutions of the design. Wrote all javascript/jQuery for front-end functionality.</p>
        				<a href="projects/proj-quote-apply.php" class="primary-button">Read more</a>
                        <div class="project-thumbnail">
                    		<a href="#">
                            	<img src="img/projects/cv-project-quote-apply.gif" width="960" height="937" alt="Project preview">
                            </a>
                        </div>
                    </section>
<!--
                    <section class="job-project">
                        ...
                        <div class="project-thumbnail">
                    		<a href="https://itunes.apple.com/gb/app/vitalitylife-myplan/id657868651?mt=8">
                            	<img src="img/projects/cv-project-myPlan.jpg" width="480" height="360" alt="Project preview">
                            </a>
                        </div>
                    </section>
-->
    ...
    <img src="../img/assumetheposition.jpg" alt="Ded" width="300" style="position:absolute;bottom:-1rem;right:0">
</div>
</body>
</html>
